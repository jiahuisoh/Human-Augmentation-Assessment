    ...
    <div className="bg-amber-50 border-2 border-amber-400 rounded-2xl p-5 flex items-start gap-4">
      ...
      <div className="flex-1">
        <h3 className="text-lg font-bold text-amber-900">
          Account Not Yet Verified — Tokens Locked
        </h3>
        <p className="text-base text-amber-800 mt-1 leading-relaxed">
          You can still complete assessments, but <strong>tokens cannot be awarded</strong> until your identity is verified by HANA Staff.
        </p>
        <div className="mt-3 bg-white rounded-xl p-3 border border-amber-200">
          <p className="text-sm font-bold text-amber-900 mb-1">How to unlock your tokens:</p>
          <ol className="text-sm text-amber-800 space-y-1 list-decimal list-inside">
            ...
            <li>Tokens will unlock immediately</li>
          </ol>
        </div>
      </div>
